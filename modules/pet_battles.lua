...
if battle_pets then
	...
	function aObj:checkPetHealth(battleEnded, time)
		printD("Checking BattlePets health", battleEnded, time, lTime)
		...
		printD("cPH - Spell", rbp[1], rbp[2], rbp[3])
		-- Pet Battle ended
		if battleEnded then
		...
		-- first time through
			...
			printD("cPH numPets", numPets, numOwned)
			for i = 1, numPets do
				...
				printD(petID, isOwned, customName, name)
